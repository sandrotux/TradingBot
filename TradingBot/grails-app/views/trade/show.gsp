...
<html>
    ...
    <body>
        ...
        <div id="show-trade" class="content scaffold-show" role="main">
            ...
            <f:display bean="trade" />
            <g:form resource="${this.trade}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.trade}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
